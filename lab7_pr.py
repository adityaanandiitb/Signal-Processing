...
class lab7_pr(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab7_pr")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\ADITYA ANAND\\Desktop\\EE340\\Original_Text.txt', True, 0, 0)
...
def main(top_block_cls=lab7_pr, options=None):
